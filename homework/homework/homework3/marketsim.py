...
startCash = 50000
orderFile = "orders_h4-0.csv"
valueFile = "values_h4-0.csv"


orderDF = pd_par.read_csv(orderFile, header=None, usecols=[0,1,2,3,4,5])
...
dt_start = dt.datetime( orderDF.head(1)[0], orderDF.head(1)[1], orderDF.head(1)[2])
dt_end = dt.datetime( orderDF.tail(1)[0], orderDF.tail(1)[1], orderDF.tail(1)[2] + 1 )
